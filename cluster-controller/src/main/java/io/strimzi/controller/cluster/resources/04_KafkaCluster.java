...
public class KafkaCluster extends AbstractCluster {
    ...
    private static final String HEADLESS_NAME_SUFFIX = NAME_SUFFIX + "-headless";  // -kafka-headless
    private static final String METRICS_CONFIG_SUFFIX = NAME_SUFFIX + "-metrics-config";  // -kafka-metrics-config
    ...
    public static KafkaCluster fromConfigMap(ConfigMap kafkaClusterCm) {
        ...
        KafkaCluster kafka = new KafkaCluster(
            kafkaClusterCm.getMetadata().getNamespace(),
